                                    ...
                                    >
                                        <div className="font-medium truncate flex items-center" title={folder}>
                                            ...
                                            {folderIndexingStatus[folder] && (
                                                <svg className="w-4 h-4 ml-2 animate-spin text-blue-400" fill="none"
                                                     viewBox="0 0 24 24">
                        ...
                        <div className="flex-1 max-w-md mx-4">
                            <div className="relative">
                                ...
                                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    {isSearching ? (
                                        <svg className="animate-spin h-4 w-4 text-gray-400" fill="none"
                                             viewBox="0 0 24 24">
                                                        ...
                                                        >
                                                            <div className="aspect-video bg-gray-700 relative">
                                                                ...
                                                                {video.duration_seconds && video.duration_seconds > 0 && (
                                                                    <div
                                                                        className="absolute bottom-1 right-1 bg-black bg-opacity-75 text-white text-xs px-1 py-0.5 rounded">
