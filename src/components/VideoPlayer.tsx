      ...
      <div className="bg-gray-900 bg-opacity-90 p-4">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
            <div>
              <p><span className="font-medium">File:</span> {video.file_path.split(/[/\\]/).pop() || video.file_path}</p>
              <p><span className="font-medium">Duration:</span> {video.duration_seconds ? formatDuration(video.duration_seconds) : 'Unknown'}</p>
            </div>
            <div>
              <p><span className="font-medium">Description:</span> {video.description || 'No description available'}</p>
            </div>
          </div>
