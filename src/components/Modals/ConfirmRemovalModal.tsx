            ...
            >
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                        ...
                        <h3 className="text-lg font-semibold text-gray-200">Remove Folder</h3>
                    </div>
                ...
                <div className="mb-6">
                    <p className="text-gray-300 mb-2">Are you sure you want to remove this folder from your library?</p>
                    <div className="bg-gray-700 rounded-lg p-3 mb-4">
                        <p className="text-sm font-medium text-gray-200 mb-1">
                            {folderToRemove.split(/[/\\]/).pop() || folderToRemove}
                        </p>
                        <p className="text-xs text-gray-400 break-all">{folderToRemove}</p>
                    </div>
